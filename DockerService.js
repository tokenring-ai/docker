...
export default class DockerService extends Service {
 ...
 static constructorProperties = {
  host: {
   type: "string",
   required: false,
   description: "Docker host URL (e.g., tcp://remote-host:2375 or ssh://user@host). Defaults to unix:///var/run/docker.sock"
  },
  tlsVerify: {
   type: "boolean",
   required: false,
 ...
 constructor({ host = "unix:///var/run/docker.sock", tlsVerify = false, tlsCACert, tlsCert, tlsKey } = {}) {
  super();
  this.host = host;
